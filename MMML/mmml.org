...
#+INCLUDE: "examples/01-hello_world.mmml" example
...
#+INCLUDE: "examples/02-entrada-saida.mmml" example
...
#+INCLUDE: "examples/09-bool-coertion.mmml" example
...
in
   {get campo1 x, get campo1 x1}  // retorna {1, 2}
   // ...
#+END_SRC
